terraform {
  source = "git@github.com:aldra-consulting/infrastructure-modules.git//packages/static-website?ref=static-website@0.1.0"
}
  ...
  static_websites = [
    {
      ...
      domain = local.environment.project.domain_name
    }
  ]
}
